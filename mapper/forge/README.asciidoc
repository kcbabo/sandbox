== data-mapper
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The data-mapper addon enables blah blah...)
...
----
<dependency>
   <groupId>org.jboss.mapper.forge</groupId>
